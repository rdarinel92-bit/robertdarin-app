...
CREATE OR REPLACE FUNCTION "backup"."comparar_con_backup"() RETURNS TABLE("tabla" "text", "registros_actuales" bigint, "registros_backup" bigint, "diferencia" bigint, "estado" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_actual BIGINT;
...
ALTER FUNCTION "backup"."comparar_con_backup"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "backup"."crear_backup_completo"("p_notas" "text" DEFAULT NULL::"text") RETURNS TABLE("tabla" "text", "registros" integer, "estado" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_total INTEGER := 0;
...
ALTER FUNCTION "backup"."crear_backup_completo"("p_notas" "text") OWNER TO "postgres";
...
COMMENT ON FUNCTION "public"."crear_empleado_completo"("p_auth_user_id" "uuid", "p_email" "text", "p_nombre_completo" "text", "p_telefono" "text", "p_puesto" "text", "p_salario" numeric, "p_sucursal_id" "uuid", "p_rol_id" "uuid", "p_comision_porcentaje" numeric, "p_comision_tipo" "text") IS 'Crea un empleado completo con usuario, rol y registro de auditoría. Requiere ser admin o superior. V10.35';
...
ALTER TABLE "backup"."historial_backups" OWNER TO "postgres";
...
ALTER TABLE ONLY "backup"."historial_backups"
    ADD CONSTRAINT "historial_backups_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "climas_clientes_access" ON "public"."climas_clientes" USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "climas_equipos_access" ON "public"."climas_equipos" USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "climas_ordenes_access" ON "public"."climas_ordenes_servicio" USING (("auth"."role"() = 'authenticated'::"text"));
